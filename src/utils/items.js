...
export const ITEMS = {
  ...
  'holy-tome': {
    ...
    affinity: ['cleric'],
    cost: 1200, emoji: '📖',
    effect: 'Deal 1 damage to the active boss on every Quest completion',
    bossHealPerQuest: 1,
  },
  'quiver': {
  ...
  'stoneheart-aegis': {
    id: 'stoneheart-aegis', name: 'Stoneheart Aegis', category: 'armour', slot: 'body',
    affinity: 'all',
    cost: 6500, emoji: '🪨',
    effect: 'Reduces daily HP penalties by 25% (never fully)',
    hpPenaltyResist: 0.25,
  },
  'archmage-robes': {
  ...
  'aegis-charm': {
    id: 'aegis-charm', name: 'Aegis Charm', category: 'accessory', slot: 'neck',
    affinity: 'all',
    cost: 6000, emoji: '🛡️',
    effect: 'Reduces daily XP penalties by 25% (never fully)',
    xpPenaltyResist: 0.25,
  },
  'iron-will-talisman': {
  ...
  'clerics-amulet': {
    ...
    affinity: ['cleric'],
    cost: 1200, emoji: '☯️',
    effect: 'Deal 1 damage to the active boss each time you complete any Quest',
    bossHealPerQuest: 1,
  },
  'rangers-sigil': {
  ...
  'band-of-endurance': {
    id: 'band-of-endurance', name: 'Band of Endurance', category: 'accessory', slot: 'ring',
    affinity: 'all',
    cost: 4000, emoji: '🪬',
    effect: 'Reduces HP penalties by 15% and XP penalties by 10% (never fully)',
    hpPenaltyResist: 0.15, xpPenaltyResist: 0.10,
  },
  'rogues-signet': {
  ...
  'health-potion': {
    ...
    affinity: 'all',
    cost: 25, emoji: '🧪',
    effect: 'Restore 10 HP to yourself',
    consumable: true, playerHeal: 10,
  },
  'greater-health-potion': {
    id: 'greater-health-potion', name: 'Greater Health Potion', category: 'consumable', slot: null,
    affinity: 'all',
    cost: 75, emoji: '💊',
    effect: 'Restore 35 HP to yourself',
    consumable: true, playerHeal: 35,
  },
  'xp-scroll': {
  ...
  'healing-herbs': {
    ...
    affinity: ['cleric'],
    cost: 30, emoji: '🌱',
    effect: 'Restore 20 HP to yourself',
    consumable: true, playerHeal: 20,
  },
  'poison-vial': {
  ...
  'crystal-ball': {
    id: 'crystal-ball', name: 'Crystal Ball', category: 'magic', slot: 'off-hand',
    affinity: ['mage'],
    cost: 600, emoji: '🔮',
    effect: 'Reveals Missions at least 3 days into the future while equipped — the crystal ball shows what\'s coming.',
  },
  'enchanted-inkpot': {
...
// Raw penalty mitigation from equipped gear (penalties.js clamps to a max).
export function getPenaltyResist(character) {
  return {
    hp: sumBonus(character, 'hpPenaltyResist'),
    xp: sumBonus(character, 'xpPenaltyResist'),
  }
}
